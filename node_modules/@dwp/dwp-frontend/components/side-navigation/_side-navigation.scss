.dwp-side-navigation {
    ...
    &__item {
        ...
        &--selected {
            margin: govuk-spacing(2) 0 govuk-spacing(1) -14px;
            padding: govuk-spacing(1) 0 govuk-spacing(1) govuk-spacing(2);
            border-left: 4px solid $govuk-link-colour;
            background-color: govuk-colour("light-grey");

            @include govuk-media-query($until: tablet) {
                margin-left: 0;
                padding: govuk-spacing(0) 0 govuk-spacing(0) govuk-spacing(2);
            }
        }
